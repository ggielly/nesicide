...
NES_CXXFLAGS = -I../libs/nes -I../libs/nes/emulator -I../libs/nes/common
NES_LIBS = -L../libs/nes/$$DESTDIR -lnes-emulator
...
mac {
   ...
   QMAKE_PRE_LINK += cp ../libs/nes/$$DESTDIR/*.dylib \
      $$DESTDIR/$${TARGET}.app/Contents/Frameworks/ $$escape_expand(\n\t)
...
unix:!mac {
   ...
   NES_LFLAGS = -Wl,-rpath=\"$$PWD/../libs/nes\"
   C64_LFLAGS = -Wl,-rpath=\"$$PWD/../libs/nes\"
