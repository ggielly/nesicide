...
FAMITRACKER_CXXFLAGS = -I../build/famitracker-qt/src
FAMITRACKER_LIBS = -L../build/famitracker-qt/src/$$DESTDIR -lfamitracker
...
mac {
   ...
   QMAKE_PRE_LINK += cp ../build/famitracker-qt/src/$$DESTDIR/*.dylib \
...
unix:!mac {
   FAMITRACKER_LFLAGS = -Wl,-rpath=\"$$PWD/../build/famitracker-qt/src\"
